...
public class Email extends BaseTest {
    ...
    public static void sendEmail(){
        ...
        Session session = Session.getDefaultInstance(props,
                ...
                new javax.mail.Authenticator() {
                    ...
                    protected PasswordAuthentication getPasswordAuthentication() {
                        ...
                        return new PasswordAuthentication("udaykandimalla@gmail.com", "8185858504uK");
        ...
        try {
            ...
            message.setFrom(new InternetAddress("Udaya Kandimalla"));

            // Set the recipient address
            message.setRecipients(Message.RecipientType.TO,InternetAddress.parse("udaykandimalla@gmail.com"));
            ...
            String filename = System.getProperty("user.dir")+"/results/"+ BaseTest.TimeStamp+" Test_Automation.html";
            ...
            // set the file
            messageBodyPart2.setFileName("AutomationReport: " + BaseTest.TimeStamp+".html");
